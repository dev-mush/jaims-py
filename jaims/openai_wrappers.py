...
class JAImsGPTModel(Enum):
    ...
    GPT_4_o = ("gpt-4o", 128000, 0.00, 0.0)
    GPT_4_o_2024_05_13 = ("gpt-4o-2024-05-13", 128000, 0.00, 0.0)
    GPT_4_o_2024_08_06 = ("gpt-4o-2024-08-06", 128000, 0.00, 0.0)
    GPT_4_o_mini = ("gpt-4o-mini", 128000, 0.00, 0.0)
    GPT_4_o_mini_2024_07_18 = ("gpt-4o-mini-2024-07-18", 128000, 0.00, 0.0)
    GPT_4_TURBO = ("gpt-4-turbo", 128000, 0.00, 0.0)
    GPT_4_TURBO_2024_04_09 = ("gpt-4-turbo-2024-04-09", 128000, 0.00, 0.0)
    GPT_4_TURBO_PREVIEW = ("gpt-4-turbo-preview", 128000, 0.00, 0.0)
    GPT_4_0125_PREVIEW = ("gpt-4-0125-preview", 128000, 0.00, 0.0)
    GPT_4_1106_PREVIEW = ("gpt-4-1106-preview", 128000, 0.00, 0.0)
